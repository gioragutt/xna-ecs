...
namespace XnaTry
{
    ...
    public class XnaTryGame : Game
    {
        ...
        void Initialize_ECS_Example()
        {
            ...
            // WASD
            entity.Components.Add(new KeyboardDirectionalInput(new KeyboardSettings(Keys.A, Keys.D, Keys.W, Keys.S)));
            // Arrow Keys
            entity.Components.Add(new KeyboardDirectionalInput());
            // Numpad Arrows
            entity.Components.Add(new KeyboardDirectionalInput(new KeyboardSettings(Keys.NumPad4, Keys.NumPad6, Keys.NumPad8, Keys.NumPad2)));
